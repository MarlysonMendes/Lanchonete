...
namespace Lanchonete.Migrations
{
    public partial class PopularLanches : Migration
    {
        ...
        {
            migrationBuilder.Sql("INSERT INTO Lunches(CategoryId,ShortDescription,DetailedDescription,InStock,ImageThumbnailUrl,ImageUrl,IsFavoriteLouch,LuchName,Price) " +
